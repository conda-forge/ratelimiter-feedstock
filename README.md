About ratelimiter-feedstock
===========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ratelimiter-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=1828&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ratelimiter-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ratelimiter` can be installed with `conda`:
...
```
mamba install ratelimiter
```

It is possible to list all of the versions of `ratelimiter` available on your platform with `conda`:
...
```
mamba search ratelimiter --channel conda-forge
```
...
mamba repoquery search ratelimiter --channel conda-forge

# List packages depending on `ratelimiter`:
mamba repoquery whoneeds ratelimiter --channel conda-forge

# List dependencies of `ratelimiter`:
mamba repoquery depends ratelimiter --channel conda-forge
```
